  ...
  return (
    <div className="h-screen flex flex-col">
      <header className="flex items-center h-14 px-6 border-b border-surface-800 bg-surface-950/80 backdrop-blur-sm">
        <h1 className="text-sm font-semibold text-surface-100">Content Calendar</h1>
      </header>
      <div className="flex-1 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-surface-400">The Content Calendar is under development.</p>
        </div>
      </div>
    </div>
  );
