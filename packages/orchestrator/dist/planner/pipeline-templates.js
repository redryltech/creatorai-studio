 ...
 */
export function templateStepToPipelineStep(template, input = {}) {
    return {
        id: template.id,
 ...
 */
export const FULL_VIDEO_PIPELINE = {
    id: 'full_video',
 ...
 */
export const SCRIPT_ONLY_PIPELINE = {
    id: 'script_only',
 ...
 */
export const THUMBNAIL_ONLY_PIPELINE = {
    id: 'thumbnail_only',
    name: 'Thumbnail Generation',
 ...
 */
export const RESEARCH_ONLY_PIPELINE = {
    id: 'research_only',
    name: 'Trend Research',
 ...
 */
export const VOICEOVER_ONLY_PIPELINE = {
    id: 'voiceover_only',
    name: 'Voiceover Generation',
 ...
 * SEO-only pipeline.
 */
export const SEO_ONLY_PIPELINE = {
    id: 'seo_only',
    name: 'SEO Generation',
...
//# sourceMappingURL=pipeline-templates.js.map