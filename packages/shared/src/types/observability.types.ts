// ============================================================
// CreatorAI Studio — Observability Types
// ============================================================
// Structured metrics, traces, and health data for monitoring
// the platform's AI operations.
// ============================================================
...
export interface MetricPoint {
  ...
  tags: Record<string, string>;     // e.g., { agentId: "script", providerId: "openai" }
  timestamp: Date;
}
...
export interface AuditLogEntry {
  ...
  action: string;                    // e.g., "project.create", "workspace.member.invite"
  category: 'auth' | 'project' | 'asset' | 'workflow' | 'workspace' | 'memory' | 'brand' | 'publish' | 'settings' | 'system';

  /** What was acted upon */
  resource: {
    type: string;                    // e.g., "project", "asset", "workspace"
    id: string;
    name: string | null;
  };
