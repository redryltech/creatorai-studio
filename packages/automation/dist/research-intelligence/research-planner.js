...
export class ResearchPlanner {
    ...
    static research(topic) {
        ...
        if (recommendedPlatforms.length === 0)
            recommendedPlatforms.push('youtube_shorts');
        ...
        const confidenceScore = Math.round(trends.overallTrendScore * 0.2 +
    ...
    static computeQualityMetrics(trends, keywords, competitors, audience, contentGaps) {
        const completeness = Math.min(100, (trends.signals.length > 0 ? 20 : 0) +
        ...
        const confidence = Math.min(100, Math.round(trends.overallTrendScore * 0.3 + keywords.overallSeoScore * 0.3 + audience.engagementPrediction * 0.4));
...
//# sourceMappingURL=research-planner.js.map