...
export class SfxPlanner {
    static generate(scenes, outputDir) {
        ...
        for (const scene of scenes) {
            ...
            if (selection.ambient) {
                ...
                if (ambientTrack)
                    categories[ambientTrack.category] = (categories[ambientTrack.category] ?? 0) + 1;
            }
            // Generate transition
            ...
            if (selection.transition) {
                ...
                if (transitionEffect)
                    categories[transitionEffect.category] = (categories[transitionEffect.category] ?? 0) + 1;
            }
...
//# sourceMappingURL=sfx-planner.js.map