...
export class VideoGenerationAgent {
    ...
    async execute(input, onProgress, cancellation) {
        ...
        if (!provider) {
            ...
            const clips = prompts.prompts.map((p, i) => {
        ...
        for (const prompt of prompts.prompts) {
            ...
            try {
                ...
                log.error('Video clip generation failed', { sceneId: prompt.sceneId }, err);
            }
            completed++;
...
//# sourceMappingURL=video-gen-agent.js.map