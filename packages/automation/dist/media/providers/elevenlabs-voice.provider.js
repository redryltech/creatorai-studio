...
export class ElevenLabsVoiceMediaProvider {
    providerId = 'elevenlabs_voice';
    ...
    async generate(request) {
        ...
        if (!text || text.trim().length < 2)
            throw new Error('Text is required (min 2 characters)');
        const voiceInput = request.voiceId ?? this.defaultVoiceId;
...
//# sourceMappingURL=elevenlabs-voice.provider.js.map