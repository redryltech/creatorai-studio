export type EntityCategory = 'human' | 'vehicle' | 'animal' | 'product' | 'building' | 'weapon' | 'prop' | 'logo' | 'brand_asset';
...
export interface ContinuityIssue {
    sceneId: string;
    entityId: string;
    issueType: 'character_change' | 'vehicle_change' | 'environment_mismatch' | 'lighting_mismatch' | 'weather_mismatch' | 'missing_accessory' | 'different_clothing' | 'wrong_color' | 'different_vehicle_part' | 'unexpected_removal';
