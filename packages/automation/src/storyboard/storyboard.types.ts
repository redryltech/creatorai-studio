// ============================================================
// CreatorAI Studio — Storyboard Engine Domain Types
// ============================================================
// The visual blueprint that every AI provider follows.
// This is the single source of truth for every frame
// before image/video generation begins.
// ============================================================
...
// ════════════════════════════════════════════════════════════
// Storyboard Frame — the complete specification for one frame
// ════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════
// Storyboard — the complete visual blueprint
// ════════════════════════════════════════════════════════════
...
export interface StoryboardExportPackage {
  ...
  timelineJson: {
    totalDuration: number;
    frames: Array<{ id: string; start: number; end: number; duration: number; transition: string }>;
  };
  /** Prompts-only package (for generation engines) */
  promptPackage: {
    imagePrompts: Array<{ sceneId: string; prompt: string; negative: string }>;
    videoPrompts: Array<{ sceneId: string; prompt: string; negative: string }>;
    thumbnailPrompts: Array<{ sceneId: string; prompt: string }>;
  };
