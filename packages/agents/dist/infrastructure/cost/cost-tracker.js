...
export class CostTracker {
     ...
     */
    setFlushCallback(callback, intervalMs = 10000) {
     ...
     */
    async flush() {
        if (this.records.length === 0 || !this.flushCallback)
            return;
        ...
        try {
            ...
            log.error('Failed to flush cost records', { count: batch.length }, error);
        }
    }
    /**
